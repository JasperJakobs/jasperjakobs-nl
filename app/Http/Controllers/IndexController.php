...
class IndexController extends Controller
{
    ...
    public function randomLoadingMessage() {
        $loadingMessages = [
            ...
            "Een ogenblik geduld terwijl een grotere softwareleverancier in Seattle de wereld overneemt",
            "We stellen je geduld op de proef",
            "Alsof je een andere keuze had",
            "Volg het Witte konijn",
            "Waarom bestel je geen broodje?",
            "keep calm en npm install",
            ...
            "De kers op de taart. De taart is geen leugen...",
            ...
            "Je gaat nog niet voorbij! nog..",
            "Laad het en ze zullen komen",
            "AI overtuigen om niet kwaad te worden..",
            "Er is geen lepel. Omdat we nog niet klaar zijn met laden",
            ...
            "Water besparen en samen douchen?",
            ...
            "Graag volhouden, want onze stagiaire stopt met vim...",
            "De winter komt eraan...",
            "Afhankelijkheden installeren",
            "Overschakelen naar het nieuwste JS-framework...",
            ...
            "Het is 22:00 uur. Weet jij waar je kinderen zijn?",
            "In afwachting dat Daenerys al haar titels zegt...",
            "Voel je vrij om in je stoel te draaien",
            "Vergeet dat je dat wachtwoord hebt gezien dat ik zojuist in de IM heb getypt ...",
            "Wat zit daaronder?",
            "Uw computer heeft een virus, de naam is Windows!",
            ...
            "Wat is het verschil tussen een nijlpaard en een zippo? De ene is echt zwaar, de andere een beetje lichter",
            ...
            "Leef lang en bloei.",
            "Er is geen koeienniveau, maar wel een geit!",
            ...
            "Composer hack: Wachten tot reqs worden opgehaald is minder frustrerend als je -vvv aan je commando toevoegt.",
